 ...
 *
 */
class EarlySickness : SystemTest() {
    override val name = "EarlySickness"

    override val map = "earlySickness/map.dot"
    override val assets = "earlySickness/assets.json"
    override val scenario = "earlySickness/scenario.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("Staff Allocation: One(1) allocated to 1 for 1")
        ...
        assertNextLine("Simulation Statistics: 3 shifts worked")
        assertNextLine("Simulation Statistics: 4 ticks worked")
    }
}
