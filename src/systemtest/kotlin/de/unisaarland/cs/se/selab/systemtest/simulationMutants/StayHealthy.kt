 ...
 *
 */
class StayHealthy : SystemTest() {
    override val name = "StayHealthy"

    override val map = "StayHealthy/map.dot"
    override val assets = "StayHealthy/assets.json"
    override val scenario = "StayHealthy/scenario.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("Staff Available: One(1) available again")
        ...
        assertNextLine("Simulation Statistics: 3 ticks worked")
    }
}
